...
<el-container>
	<el-main style="padding:0px;">
		<div class="wrapper" >
			...
			<div class="lvl_data" style="width:100%;">
				<table class="" >
				...
				<tr>
					<td>护甲</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+this.$store.state.heroData.AttributeBaseAgility*0.16).toFixed(1)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*1)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*2)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*3)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*4)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*5)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*6)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*7)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*8)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*9)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*10)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*11)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*12)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*13)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*14)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*15)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*16)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*17)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*18)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*19)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*20)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*21)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*22)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*23)*16)/1000).toFixed(2)}}</td>
					<td>{{(this.$store.state.heroData.ArmorPhysical+((this.$store.state.heroData.AttributeBaseAgility*10+heroData.AttributeAgilityGain*10*24)*16)/1000).toFixed(2)}}</td>
				</tr>
				<!-- <tr><td>攻击间隔</td></tr> -->
				</table>
			</div>
			<HeroMatchSimulate></HeroMatchSimulate> 
		</div>
...
<script>
const HeroMatchSimulate=()=>import('@/components/HeroMatchSimulate.vue')
const CustomSimulation=()=>import('@/components/CustomSimulation.vue')
...
export default{
	...
	mounted(){
		var version=this.$route.query.version
		var heroname=this.$route.query.heroname
		var position=this.$route.query.heroname.position
		var param={"version":version,"heroname":heroname,"position":position}
